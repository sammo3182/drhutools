...
To draw a polygon map, the dataset should be formatted with full city or provincial names. If your data lacks this format, tools such as [`regioncodes`](https://cran.r-project.org/web/packages/regioncode/) can help convert the data. 

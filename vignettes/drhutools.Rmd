...
The `goodmap` function is designed to create interactive maps and animations based on data provided in a CSV file. It supports both point and polygon maps, allowing for versatile data visualization. This vignette will guide you through using the `goodmap` function with practical examples.
...
Before running this function, please set the environment language:
...
### Figure: Province Map for 2011
```{r out.width = '70%', echo = FALSE}
knitr::include_graphics("province_map_2011.png")
```

### Figure: Province Map for 2012
```{r out.width = '70%', echo = FALSE}
knitr::include_graphics("province_map_2012.png")
```

### Figure: Animation for Years
```{r out.width = '70%', echo = FALSE}
knitr::include_graphics("animation_year.gif")
```
...
### Figure: Point Map for 2021
```{r out.width = '70%', echo = FALSE}
knitr::include_graphics("point_map_2021.png")
```

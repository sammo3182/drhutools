...
In this data structure, users can use `g_lat` and `g_lon` to set up the latitudes and longitudes of the points and vary the column `value_set` to set the size of the points. 
```{r point-output}
goodmap(
  toy_point,
  type = "point"

...
#' @example 
#' 
#' column_names <- c('Q3|R3', 'Q3|R4', 'Q4|R3', 'Q4|R4', 'Q5|R5', 'Q5|R6', 'Q6|R3', 'Q6|R4', 'Q7|R3', 'Q7|R4', 'Q8|R5', 'Q8|R6', 'Q9|R5', 'Q9|R6', 'Q10|R5', 'Q10|R6', 'Q11|R5', 'Q11|R6', 'Q12|R3', 'Q12|R4', 'Q13|R3', 'Q13|R4', 'Q14|1', 'Q15|1', 'Q16|1', 'Q17|1', 'Q18|1', 'Q19|1', 'Q20|1', 'Q21|1', 'Q22|1', 'Q23|1', 'Q24|1', 'Q25|1' )
#' 
#' toy_data <- data.frame(matrix(sample(1:5, 10 * length(column_names), replace = TRUE), ncol = length(column_names))) 
#' 
